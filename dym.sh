...
echo -e "Your chain name: \e[1m\e[32m$DYM_CHAIN_ID\e[0m"
echo -e "Your port: \e[1m\e[32m$DYM_PORT\e[0m"
echo '================================================='
sleep 2
...
echo -e "To check Blocks status : \e[1m\e[35mcurl -s localhost:${DYM_PORT}657/status | jq .result.sync_info\e[0m"
echo ""
sleep 3
